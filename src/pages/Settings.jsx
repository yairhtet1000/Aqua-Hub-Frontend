  ...
  return (
    <div className="mx-auto grid w-[min(1000px,100%)] grid-cols-[230px_minmax(0,1fr)] gap-5 max-md:grid-cols-1">
      ...
      <section className="grid gap-5">
        <div className="rounded-[2rem] bg-slate-950 p-7 text-white shadow-2xl shadow-teal-950/20">
        ...
        {passwordSection ? (
          <form className="grid gap-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-950/5 dark:border-slate-800 dark:bg-slate-950">
          ...
          <form className="grid gap-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-950/5 dark:border-slate-800 dark:bg-slate-950">
            <div className="flex flex-wrap items-center gap-4 rounded-3xl bg-slate-50 p-4 dark:bg-slate-900">
              ...
              />
              <button
                className="inline-flex h-11 min-w-56 items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 text-sm font-black text-slate-600 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300"
                type="button"
              >
                <Camera size={18} />
            ...
            <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
              <label className={labelClass}>
                Name
                <input className={fieldClass} defaultValue={currentUser.name} />
              </label>
              <label className={labelClass}>
                Username
                <input className={fieldClass} defaultValue={currentUser.username} />
              </label>
            </div>
            <label className={labelClass}>
              Bio
            ...
            <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
              <label className={labelClass}>
                ...
                <input
                  ...
                  defaultValue={currentUser.favoriteFish}
                />
              </label>
              <label className={labelClass}>
                Location
                <input className={fieldClass} defaultValue={currentUser.location} />
              </label>
            </div>
            <button
